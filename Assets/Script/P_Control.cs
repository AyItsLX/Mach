...
public class P_Control : MonoBehaviour {
    ...
    private bool rightTurn, leftTurn = false;
    ...
    void Start () {
        ...
        healthUI.transform.localScale = new Vector3(playerHealth / 100, 1, 1);
    }
	...
	void Update () {
        ...
        if (playerHealth <= 0)
        {
            ...
            gameManager.UpdateComboThenSwitch();
        }
        #endregion
    }
